...
import { type TeaWare, TeaWareType } from '@/types/teaware'
...
export const teawares: TeaWare[] = [
  // ============ 基础款（初始即可用）============
  {
    ...
    material: '白瓷（釉面）',
    description:
      '瓷器釉面光滑不吸味，薄壁散热适中，出汤速度可控。适合冲泡大多数茶类，尤其高香细嫩茶。',
    story:
      '盖碗始于明代，又称"三才碗"——盖为天、托为地、碗为人。鲁迅在《喝茶》中写道："喝好茶，是要用盖碗的。"',
  ...
  },
  {
    ...
    description:
      '紫砂双气孔结构保温性极佳，会吸附茶味形成"茶山"（建议一壶一茶）。适合普洱、红茶、焙火乌龙。',
  ...
  },
  {
    ...
    material: '高硼硅玻璃',
    description:
      '玻璃完全无孔不吸味、导热快散热最快。透明度高，可全程欣赏茶叶舒展与"茶舞"，视觉体验最佳。',
    story:
      '玻璃茶具虽不如瓷器紫砂历史悠久，但现代高硼硅玻璃的耐热性能使其成为观赏绿茶茶舞的理想之选。',
  ...
  // ============ 进阶款（需解锁）============
  {
    ...
    material: '龙泉青瓷（釉面）',
    description:
      '龙泉青瓷以"青如玉、明如镜、声如磬"著称。釉色温润，与绿茶茶汤相映成趣，视觉享受极佳。',
  ...
  },
  {
    ...
    story:
      '石瓢壶为紫砂经典器型之一，源自清代陈曼生设计的"曼生十八式"，一改紫砂繁复之风，开文人壶先河。',
  ...
  },
  {
    ...
    material: '建阳铁胎（黑釉）',
    description:
      '建盏为宋代点茶神器，铁胎厚实保温极佳。兔毫/油滴釉面在茶汤映照下流光溢彩，极具观赏性。',
    story:
      '建盏产自福建建阳，宋代点茶之风最尚黑釉盏，宋徽宗《宫词》咏道："兔毫连盏烹云液，能解红颜入醉乡。"',
