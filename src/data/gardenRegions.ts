...
export const gardenRegions: GardenRegion[] = [
  {
    ...
    teaArea: '江南茶区',
    description:
      '西子湖畔，狮峰山下，千年贡茶核心产区。丘陵梯田翠绿茶垄，云雾缭绕，以"色绿、香郁、味甘、形美"四绝闻名。',
  ...
  },
  {
    ...
    teaArea: '华南茶区',
    description:
      '丹霞地貌，三十六峰九十九岩，茶树生长于岩壁缝隙砾土中。"看青做青、看天做青"，岩骨花香，联合国人类非物质文化遗产。',
  ...
  },
  {
    ...
    teaArea: '西南茶区',
    description:
      '世界茶树原产地中心，原始森林中千年古茶树参天。大叶种茶，低纬度高海拔，"冬无严寒夏无酷暑"，普洱茶发祥地，茶马古道源头。',
  ...
  },
  {
    ...
    teaArea: '华南茶区',
    description:
      '太姥山下，东海之滨，白茶发源地。"世界白茶在中国，中国白茶在福鼎"。不炒不揉，自然萎凋，日晒干燥，一年茶三年药七年宝。',
