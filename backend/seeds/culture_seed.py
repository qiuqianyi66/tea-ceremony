...
SEED_PEOPLE = [
    {"name": "陆羽", "dynasty": "唐", "identity": "茶圣", "description": "撰《茶经》三卷十篇，系统论述茶之源、具、造、器、煮、饮、事、出、略、图，奠定中国茶文化的理论基础。", "quote": "茶者，南方之嘉木也。"},
    {"name": "苏轼", "dynasty": "宋", "identity": "茶中诗仙", "description": '一生爱茶，写下近百首茶诗。“活水还须活火烹”的烹茶理念影响深远。', "quote": "且将新火试新茶，诗酒趁年华。"},
    {"name": "陆游", "dynasty": "宋", "identity": "茶诗第一", "description": "一生创作三百余首茶诗，是中国历史上写茶诗最多的诗人。", "quote": "晴窗细乳戏分茶。"},
    {"name": "乾隆", "dynasty": "清", "identity": "六下江南品茶帝", "description": "六下江南，四次驾临龙井茶区，亲封十八棵御茶树，推动龙井茶名扬天下。", "quote": "火前嫩，火后老，惟有骑火品最好。"},
    {"name": "袁枚", "dynasty": "清", "identity": "随园茶客", "description": "著《随园食单》，提出品茶三境界：始觉其清，再酌其香，终品其韵。", "quote": "始觉其清，再酌其香，终品其韵。"},
    {"name": "宋徽宗赵佶", "dynasty": "宋", "identity": "皇帝茶人", "description": "亲撰《大观茶论》，是中国历史上唯一为茶著书立说的帝王。", "quote": "至若茶之为物，致清导和。"},
    {"name": "白居易", "dynasty": "唐", "identity": "茶中隐士", "description": "晚年号香山居士，嗜茶如命，在《琵琶行》等名篇中多次提及茶事。", "quote": "无由持一碗，寄与爱茶人。"},
    {"name": "卢仝", "dynasty": "唐", "identity": "七碗茶歌者", "description": '以“七碗茶诗”闻名——一碗喉吻润，两碗破孤闷，七碗吃不得也。', "quote": "七碗吃不得也，唯觉两腋习习清风生。"},
    {"name": "欧阳修", "dynasty": "宋", "identity": "文忠公茶客", "description": '在《归田录》中详记宋代贡茶制度，提出“茶之品无有贵于龙凤者”。', "quote": "吾年向老，世味渐薄。惟于茶，不能忘情。"},
    {"name": "李清照", "dynasty": "宋", "identity": "茶中词后", "description": '“赌书泼茶”的典故成为文人茶事的经典意象。', "quote": "酒阑更喜团茶苦，梦断偏宜瑞脑香。"},
]
